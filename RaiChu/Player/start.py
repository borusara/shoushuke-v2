...
async def kstart(_, message: Message):
...
async def help(client: Client, message: Message):
    await message.reply_photo(
        photo=f"https://telegra.ph/file/e83b15d567d81e6660834.jpg",
        caption=f"""Currently The Repository Is Private""",
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
                        " ʀᴇᴘᴏ ⚒️", url=f"https://t.me/primes_arena")
                ]
            ]
        ),
    )
